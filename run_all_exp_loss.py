...
def main():
    ...
    ap.add_argument("--results-root", type=str, default="ablation_results_loss")
    ...
    base_net = {
        ...
        "latency_per_km": 5.0,
        "base_loss_ms": 0.02,
        "loss_per_100m": 0.065,  # 0.03, 0.045, 0.06
        "out_of_range": 900.0,
        "chunk_size_kb": 4,
    }

    loss_per_km = base_net.get("loss_per_100m") * 100
    results_root = ensure_dir(Path(args.results_root)) / f"loss_{str(loss_per_km)}"
