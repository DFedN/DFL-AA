...
#!/usr/bin/env python3
"""
run_all_exp_fixed.py
==================
Memory-efficient version with proper Ray configuration for 50+ nodes.
"""
...
def main():
    ...
    ap.add_argument("--runtime-s", type=int, default=1000)
    ...
    ap.add_argument("--results-root", type=str, default="ablation_results_scalable")

    ap.add_argument("--cpus-per-actor", type=float, default=0.7)
    ...
    results_root = ensure_dir(Path(args.results_root)) / f"nodes_{args.num_nodes}"
