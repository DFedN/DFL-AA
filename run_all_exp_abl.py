...
run_all_exp_abl.py
============
Rin all ablations: Component wise analysis of DFL-AA
  ...
  python run_all_exp_abl.py \
    ...
    --datasets mnist \
    --alphas 0.1,0.5 \
    --aggregations softSGD_s,softSGD_c,dflaa_s,dflaa_c
"""
...
from dfl_core_abl import DFedNode 
...
def main():
    ...
    ap.add_argument("--aggregations", type=str, default="softSGD,softSGD_s,dflaa,dflaa_s")
    ...
    ap.add_argument("--results-root", type=str, default="ablation_results")
